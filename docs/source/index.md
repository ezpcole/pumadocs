...
This is a document containing lots of information that can be useful to new teams or anybody looking to find more information on a specific topic

## Links

* [VEX CAD Fusion 360 Library](https://github.com/VEX-CAD/VEX-CAD-Fusion-360-Library)
* [VEX CAD Discord Server](https://discord.gg/BKV3DJm)
* [Onshape](https://www.onshape.com/)
* [Onshape Importing VEX V5 Parts Tutorial](https://www.youtube.com/watch?v=pgTIe8Irk-4&list=PL4FdDkwWXT9oO7ax1Itd_a6C2-8p8EzaO)
* [Protobot Rebuilt](https://github.com/BreadSoup/Protobot-Rebuilt/releases)
* [5203G Gremin (2025 vex worlds excellence winner)'s notebook](https://heyzine.com/flip-book/7005792d0e.html#page/1)
